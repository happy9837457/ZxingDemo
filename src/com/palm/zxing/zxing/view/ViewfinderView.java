package com.palm.zxing.zxing.view;
...
public final class ViewfinderView extends View {
	 ...
	 * 
	 */
	private static final int OPAQUE = 0xFF;// 透明度
	/**
	 * 
	 */
	private int screenRate;// 边缘宽度

	/**
	 *
	 */
	private static final int CORNER_WIDTH = 10;// 边缘线粗细
	/**
	 * 
	 */
	 ...
	 * 
	 */
	private static final int SPEEN_DISTANCE = 5;// 扫描线速度
	 ...
	 *
	 */
	private static final int TEXT_PADDING_TOP = 30;// 文字上边距
