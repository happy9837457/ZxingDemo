...
import com.palm.zxing.zxing.camera.PlanarYUVLuminanceSource;
	...
	private void decode(byte[] data, int width, int height) {
		...
		if (rawResult != null) {
			...
			Message message = Message.obtain(activity.getHandler(),
					CaptureActivityHandler.id_decode_succeeded, rawResult);
			...
			Message message = Message.obtain(activity.getHandler(),
					CaptureActivityHandler.id_decode_failed);
			message.sendToTarget();
		}
	}
